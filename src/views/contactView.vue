    ...
    <div class="contact-shell">
      <header class="hero" aria-label="Présentation de la page de contact">
        <div class="hero-text">
          ...
          <p class="subtitle">
            Je ne fais pas de missions freelance. Pour un retour sur mes projets, une opportunité
            salariée ou un échange produit, partage quelques lignes de contexte et je réponds sous
            24–48 h ouvrées.
          </p>
          <div class="hero-meta">
        ...
        <div class="hero-panel" aria-label="Coordonnées directes">
          ...
          <p class="panel-note">
            Précise si c'est pour un retour, une opportunité salariée ou une collab produit. Pas de
            missions freelance.
          </p>
      ...
      <div class="cards">
        ...
        <article class="card">
          ...
          <p>
            Pour un retour sur mes projets, une opportunité salariée ou une collaboration produit,
            privilégie l'e-mail : je peux répondre avec des détails et des pistes concrètes. Je ne
            prends pas de missions freelance.
          </p>
        ...
        <article class="card">
          ...
          <ul class="list links-list">
            ...
            <li>
              <a :href="links.linkedin" target="_blank" rel="noopener" class="link">LinkedIn</a>
            </li>
            <li v-if="links.discord">
              <a :href="links.discord" target="_blank" rel="noopener" class="link">Discord</a>
            </li>
          </ul>
          <p class="muted">
            Pour un message court ou un suivi de projet, passe en privé avant de basculer sur
            l'e-mail. Pas de missions freelance.
          </p>
        </article>
        ...
        <article class="card card--highlight">
          ...
          <h2 class="card-title">
            <span class="emoji" aria-hidden="true">🧵</span> {{ filamentGestion.name }}
          </h2>
          <p>
            <strong>{{ filamentGestion.tagline }}</strong>
          </p>
          <p class="muted">{{ filamentGestion.description }}</p>
          <p v-if="filamentGestion.siteUrl" class="highlight-link">
            <a :href="filamentGestion.siteUrl" target="_blank" rel="noopener" class="link"
              >Découvrir le site</a
            >
          </p>
          <p v-if="filamentGestion.instagram" class="highlight-link">
            <a :href="filamentGestion.instagram" target="_blank" rel="noopener" class="link"
      ...
      <aside class="notice" aria-label="Informations d'utilisation des données">
        <p>
          Les informations envoyées par e-mail sont utilisées uniquement pour te répondre. Pas de
          newsletter, pas de revente.
        </p>
      </aside>
    </div>
  </section>
